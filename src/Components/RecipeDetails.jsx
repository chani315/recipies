...
const RecipeDetails=()=>{
    ...
    useEffect(()=>{
        const recipeIndex = parseInt(Id, 10) - 1;
        const selectRecipy=recipes[recipeIndex]
        setRecipe(selectRecipy || null);
    },[Id,recipes]);
    if (!recipe) {
        return <p className="notfound">טוען נתונים או שהמתכון לא נמצא...</p>;
    }
    const productsList=recipe.products
...
<div class="heart-container" title="Like">
    {/* <p>סמן כמועדף</p> */}
            <input type="checkbox" class="checkbox"  id="Give-It-An-Id" onClick={()=>dispatch(updateFavorite({recipeIndex:parseInt(Id, 10) - 1}))}/>
...
{/* 
                <img className="picture" src={`/images/recipes/${recipe.image}`} ></img>  
                <img className="picture" src={recipe.image} ></img> */}
